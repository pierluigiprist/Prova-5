...
# Fase 2: Selezione tecnico — carica dati aggiornati da Drive per avere lista tecnici corrente
elif not st.session_state.authenticated:
    # Se i dati non sono in memoria, carica da Drive (o usa default)
    if "data" not in st.session_state:
        try:
            dati_drive = carica_dati_drive()
            if dati_drive and "tecnici" in dati_drive:
