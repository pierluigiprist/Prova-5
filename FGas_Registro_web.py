[FGas_Registro_web.py](https://github.com/user-attachments/files/30738601/FGas_Registro_web.py)
#!/usr/bin/env python3
...
def trova_file_drive(service, nome):
    # Cerca il file per nome in tutto il Drive accessibile (incluse condivisioni)
...
def salva_dati_drive(dati, silent=False):
    ...
    try:
        ...
        if file_info:
            # Aggiorna il file esistente (di proprietà dell'utente, usa la quota utente)
            ...
            # NON creare il file: il service account su Gmail personale non ha quota Drive
            if not silent:
